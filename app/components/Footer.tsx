...
const menuSections = [
  ...
  { title: "Menu", links: ["Appetizers", "Salads", "Pizzas", "Main dishes", "Desserts"] },
  { title: "", links: ["Side dish", "Brunch", "Desserts", "Beverages", "Fish & Sea foods"] }, // Толгойгүй багана
];
...
export default function Footer() {
  return (
    <footer className="w-full pb-30 bg-[#18181b] text-white">
    <div className="w-full h-23 bg-[#ef4444] mt-15 flex items-center overflow-hidden whitespace-nowrap">
       <div className="flex items-center animate-marquee-custom text-white text-3xl font-semibold">
    {Array(15).fill("Fresh fast delivered").map((text, i) => (
 ...
 <Container>
  <div className="flex flex-col md:flex-row justify-between items-start flex-wrap gap-8 mb-1 pt-16 pb-8">
    ...
    {menuSections.map((section, id) => (
      <div key={id} className={section.title ? "" : "md:pt-8"}>
        {section.title && (
    ...
    <div>
      <h3 className="text-xs text-gray-500 tracking-widest uppercase mb-4">Follow us</h3>
